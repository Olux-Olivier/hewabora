...
<head>
  ...
  <title>Hewa Bora | Lounge Drinks</title>
  ...
  <style>
    ...
    body::before {
      ...
      position: fixed;
      inset: 0;
      background-image: url('https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=1920&q=80');
...
<body class="min-h-screen text-white font-sans relative">
  ...
  <section class="relative pt-32 pb-16 text-center text-white fadeIn">
    <h1 class="font-[Playfair Display] text-5xl mb-3 bg-gradient-to-r from-yellow-400 via-yellow-500 to-white bg-clip-text text-transparent drop-shadow-lg">
      Lounge Bar — Menu Drinks
    </h1>
    <p class="text-gray-300 mb-6">Savourez nos cocktails et boissons signatures 🍸</p>
