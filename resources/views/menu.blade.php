...
<body class="bg-gray-50 font-sans">
    ...
    <section class="bg-red-100 pt-24 pb-12 text-center">
        <h1 class="text-4xl md:text-5xl font-bold text-red-700 mb-3">Notre menu</h1>
    ...
    <section class="container mx-auto py-12 px-4">
        {{-- <div class="flex flex-wrap justify-center gap-2 mb-8">
            <button class="tab-btn bg-white px-4 py-2 rounded shadow text-red-600 font-semibold" data-tab="vegetable">Vegetables</button>
            <button class="tab-btn bg-white px-4 py-2 rounded shadow text-red-600 font-semibold" data-tab="fruits">Fruits</button>
            <button class="tab-btn bg-white px-4 py-2 rounded shadow text-red-600 font-semibold" data-tab="fresh">Fresh</button>
        </div> --}}
